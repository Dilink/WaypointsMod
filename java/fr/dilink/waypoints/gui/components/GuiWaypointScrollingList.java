...
public abstract class GuiWaypointScrollingList
{
	...
	public GuiWaypointScrollingList(Minecraft client, int width, int height, int top, int bottom, int left, int entryHeight) {
		this.client = client;
	...
	protected abstract void drawSlot(int var1, int var2, int var3, int var4, Tessellator var5, int var16);
	protected abstract void drawButtons(int var1, int var2, int var3, int var4, Tessellator var5, int var16);
		...
		for (var11 = 0; var11 < listLength; ++var11) {
			...
			if (var19 <= this.bottom && var19 + var13 >= this.top) {
				if (this.field_25123_p && this.isSelected(var11)) {
					...
					int varTop = (var19 - 1);
					int varBottom = (var19 + var13 + 1);
					if(var19 - 2 < this.top) varTop = (var19 - 1) + (this.top - var19 + 2);
					if(var19 + var13 + 2 > this.bottom) varBottom = (var19 + var13 + 1) - ((var19 + var13 + 2) - this.bottom);

					var18.startDrawingQuads();
					var18.setColorOpaque_I(8421504);
					var18.addVertexWithUV((double)var14, (double)varBottom + 1, 0.0D, 0.0D, 1.0D);
					var18.addVertexWithUV((double)var15, (double)varBottom + 1, 0.0D, 1.0D, 1.0D);
					var18.addVertexWithUV((double)var15, (double)varTop - 1, 0.0D, 1.0D, 0.0D);
					var18.addVertexWithUV((double)var14, (double)varTop - 1, 0.0D, 0.0D, 0.0D);
					var18.setColorOpaque_I(0);
					var18.addVertexWithUV((double)(var14 + 1), (double)varBottom, 0.0D, 0.0D, 1.0D);
					var18.addVertexWithUV((double)(var15 - 1), (double)varBottom, 0.0D, 1.0D, 1.0D);
					var18.addVertexWithUV((double)(var15 - 1), (double)varTop, 0.0D, 1.0D, 0.0D);
					var18.addVertexWithUV((double)(var14 + 1), (double)varTop, 0.0D, 0.0D, 0.0D);
					var18.draw();
					GL11.glEnable(GL11.GL_TEXTURE_2D);
					this.drawButtons(var11, boxRight, var19, var13, var18, (var19 - 1));
				}
				this.drawSlot(var11, boxRight, var19, var13, var18, (var19 - 1));
			}
		}
